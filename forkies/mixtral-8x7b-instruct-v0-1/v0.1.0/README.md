# mixtral-8x7b-instruct-v0-1 - v0.1.0

**Type:** Forkie (Upstream Snapshot)
**Source:** mistralai/Mixtral-8x7B-Instruct-v0.1
**Status:** Read-only
...
2. Create research experiment: `python3 tools/create.py research/owner/experiment --base forkies/mixtral-8x7b-instruct-v0-1@v0.1.0`
