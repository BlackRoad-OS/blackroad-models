# deepseek-coder-33b-instruct - v1.0.0
...
2. Create research experiment: `python3 tools/create.py research/owner/experiment --base forkies/deepseek-coder-33b-instruct@v1.0.0`
