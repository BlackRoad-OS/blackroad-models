# deepseek-math-7b-instruct - v1.0.0

**Type:** Forkie (Upstream Snapshot)
**Source:** deepseek-ai/deepseek-math-7b-instruct
**Status:** Read-only
...
2. Create research experiment: `python3 tools/create.py research/owner/experiment --base forkies/deepseek-math-7b-instruct@v1.0.0`
